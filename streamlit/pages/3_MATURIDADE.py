...
.painel-conformidade .kpi .num.texto{ 
  font-size:22px; 
}
...
.painel-conformidade .kpi.obtidos .num{ 
  color:var(--green); 
}

.painel-conformidade .kpi.faltam .num{ 
  color:var(--orange); 
}

.painel-conformidade .kpi.nivel .num{ 
  color:var(--blue-dark); 
}
...
.painel-conformidade .pill.boa     { 
  background:#EAF7EE; 
  color:var(--green); 
}

.painel-conformidade .pill.atencao { 
  background:#FFF1E3; 
  color:#B5601C; 
}

.painel-conformidade .pill.critica { 
  background:#FBEAEA; 
  color:#C63C3C; 
}
